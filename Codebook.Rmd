...
Script details in the file run_analysis.R

There are 5 parts
Downloading and unziping the file if it is doesn't exists in the working directory
Step 1 : loading datasets and merging test and train datasets
Step 2 : extracting mean and standard deviations measurements
step 3 : Naming descriptive activites
Step 4 : Appropritely naming variables
Step 5 : Creating independent tidy data set with the average of each variable activity and subject

Packages used in the script reshape2
final output file is in tidy.txt
